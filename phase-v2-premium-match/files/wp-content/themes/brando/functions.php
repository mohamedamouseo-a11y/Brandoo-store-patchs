...
define('BRANDO_THEME_VERSION', '0.4.1');
...
function brando_enqueue_assets(): void
{
    ...
    wp_enqueue_style('brando-footer', get_template_directory_uri() . '/assets/css/footer.css', ['brando-header'], BRANDO_THEME_VERSION);

    if (is_front_page()) {
        wp_enqueue_style('brando-hero', get_template_directory_uri() . '/assets/css/hero.css', ['brando-header'], BRANDO_THEME_VERSION);
        wp_enqueue_style('brando-categories', get_template_directory_uri() . '/assets/css/categories.css', ['brando-hero'], BRANDO_THEME_VERSION);
